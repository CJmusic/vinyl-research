...
def groove_map(audio_file, T=1.8): 
    ...
    time = np.arange(0.0,len(data))/fs ##calculates a time array in order to plot the waveform of the audio file
...
if __name__ == '__main__':
    ...
    file_dir = '1213_18_JohnandKevin/'
    file_name = 'longleadout.wav'
