% Record Wow Measurement, using segments and fft.
...
%filename='1k&315k.wav';ts=0;tf=30;%1kHz
%filename='1k&315k.wav';ts=40;tf=70;%3.15kHz
%filename='analogmagik_silent_1kHz.wav';ts=8.61;tf=15.7;%44.1 kHz

%tape-----------
%filename='MRLsm_reel.wav';ts=60;tf=80;ts2=60;tf2=80;
%filename='MRLsm_reel_1575.wav';ts=60;tf=80;ts2=60;tf2=80;
...
%-----------------prefiltering-----------
%[b,a]=butter(2,2*100/fs,'high');% not really necessary when fft is used
...
freq(1)=freq(2);%freq(2)=freq(3);%%%%%% 2i2 seems to need this for DC %%%%%%%%%%
...
centreholeoffsetmm=R*wamplitude/test_freq %offset in mm
