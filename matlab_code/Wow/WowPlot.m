...
file = '/Volumes/AUDIOBANK/audio_files/lacquer_recordings/lacquerwow/partone.wav';
...
ylabel('Freq[Hz]')
% title('zoom freq(t)')
saveas(figure(50), 'plots/unweightedfreq.png');
...
saveas(figure(90), 'plots/weightedfreq.png');
