...
plotnum = plotnum + 1;
figure(plotnum); grid on; hold on;
plot(AudioTable.record(strcmp(AudioTable.track,'quiet'),:), AudioTable.RMS_L(strcmp(AudioTable.track,'quiet'),:),'-o')
plot(AudioTable.record(strcmp(AudioTable.track,'quiet'),:), AudioTable.RMS_R(strcmp(AudioTable.track,'quiet'),:),'-o')
ylabel('RMS [dB]')
xlabel('record number')
...
plotnum = plotnum + 1;
figure(plotnum); grid on; hold on;
plot(AudioTable.record(strcmp(AudioTable.track,'quiet'),:), AudioTable.clicks_L(strcmp(AudioTable.track,'quiet'),:),'-o')
plot(AudioTable.record(strcmp(AudioTable.track,'quiet'),:), AudioTable.clicks_R(strcmp(AudioTable.track,'quiet'),:),'-o')
ylabel('RMS [dB]')
xlabel('record number')
title('record number vs RMS in quiet track')
saveas(figure(plotnum),'RMSquiet.png')
